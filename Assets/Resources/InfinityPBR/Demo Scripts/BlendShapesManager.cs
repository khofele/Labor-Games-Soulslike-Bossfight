...
namespace InfinityPBR
{
    public class BlendShapesManager : MonoBehaviour
    {
        ...
        public bool userMatchRespectsLimits = true;

        public List<BlendShapePresetFile> rangeFiles = new List<BlendShapePresetFile>();
        public List<BlendShapePresetFile> presetFiles = new List<BlendShapePresetFile>();
        ...
        public void TriggerUserMatches(BlendShapeGameObject obj, BlendShapeValue value)
        {
            ...
            {
                BlendShapeGameObject matchObj = blendShapeGameObjects[value.otherValuesMatchThis[m].objectIndex];
                BlendShapeValue matchValue = matchObj.blendShapeValues[value.otherValuesMatchThis[m].valueIndex];

                float finalValue;
                if (userMatchRespectsLimits)
                {
                    finalValue = matchValue.limitMin + (AmountBetweenMinAndMax(matchValue) * PercentFromMin(value));
                }
                else
                {
        ...
        {
           // Debug.Log("Load Blendshape Data");
