...
public class IsTargetInBoxFrontLongRange : GOCondition
{
    ...
    {
        Collider[] objectsInRange = Physics.OverlapBox(new Vector3(gameObject.transform.position.x, (gameObject.transform.position.y + 2.5f), gameObject.transform.position.z + 10), new Vector3(gameObject.transform.localScale.x + 8, gameObject.transform.localScale.y + 5, gameObject.transform.localScale.z + 15), gameObject.transform.rotation);
